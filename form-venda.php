      ...
      <div class="page-main">
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="row">              
            <div class="col-lg-12">
              <form class="card" action="acaoVenda.php" method="post">
                <div class="card-body">
		    ...
		    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select class="form-control custom-select" name="idProduto">
                          <?php
                            require_once "autoload.php";
                            $produto = new Produto;

                            $listaProdutos= $produto->listaProduto();

                            foreach ($listaProdutos as $row) {
                          ?>
                          <option value="<?php echo $row["idProduto"]?>"><?php echo $row["descricao"]?></option>
                          <?php
                            }
                          ?>
                        </select>
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Digite aqui a quantidade" name="quantidade" required="true">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control text-right" aria-label="Valor" name="valorUnitario">                          
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      ...
                      <div class="form-group">                        
                        ...
                        <div class="custom-controls-stacked">
                          <label class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" value="option1" checked name="checkValorUnitario">
		  ...
		  <div>
		    <button type="submit" class="btn btn-primary" name="insertVenda">Confirmar</button>
		  </div>                                    
                </div>                
              </form>
            </div>
                    ...
                    <table class="table card-table table-vcenter text-nowrap">
                      ...
                      <tbody>
                        <?php
                          ...
                          $listaVenda= $produto->listaVenda();
                          $cont = 1;
                          foreach ($listaVenda as $row) {
                        ?>
                        <tr>
                          <td><span class="text-muted"><?php echo $cont;?></span></td>
